...
#define OPENVPN_DEBUG_TUN     3        // debug level for tun object (2)
#define OPENVPN_DEBUG_UDPLINK 3        // debug level for UDP link object (2)
#define OPENVPN_DEBUG_TCPLINK 3        // debug level for TCP link object (2)
